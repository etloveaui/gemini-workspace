...
//TIME_DEFINITION
#define IG_OFF_SLEEP_DELAY			(10.0/T_10MS)	//10.0s
//#define INIT_TO_NORMAL_DELAY		(0.1/T_10MS)	//0.1s
#define INIT_TO_NORMAL_DELAY		(2)
#define DEBUG_INIT_TIMEOUT			(3.0/T_10MS)	//3.0s
...
#define IGNITION_DETECT_12V_THRESHOLD	(3.0)		//3V
