...
//ADC Access Modes
#ifndef ADC_ACCESS_MODE_SINGLE
#define ADC_ACCESS_MODE_SINGLE    0
#define ADC_ACCESS_MODE_STREAMING 1
#endif

//ADC Sample Count Configuration
#define SAMPLE_COUNT_STREAMING    5
#define SAMPLE_COUNT_SINGLE       1

#define ADC_BUFFER_SIZE(CHANNELS, MODE) \
    ((MODE) == ADC_ACCESS_MODE_STREAMING ? \
     (CHANNELS) * SAMPLE_COUNT_STREAMING : \
     (CHANNELS))

//ADC Group Access Mode Configuration
#define ACCESS_MODE_ADC0_HW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC1_HW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC2_HW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC3_HW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC0_SW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC1_SW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC2_SW       (ADC_ACCESS_MODE_SINGLE)
//#define ACCESS_MODE_ADC3_SW       (ADC_ACCESS_MODE_SINGLE)
#define ACCESS_MODE_ADC4_SW       (ADC_ACCESS_MODE_SINGLE)

//ADC_DATA_BUFFER
#define NUM_OF_CHANNEL_ADC0_HW		(1)	//SENS_CURR_U (SENS_CURR_U_REF)20250507										AdcConf_AdcGroup_AdcGroup0_Hw
#define NUM_OF_CHANNEL_ADC1_HW		(1)	//SENS_CURR_W (SENS_CURR_W_REF)20250507										AdcConf_AdcGroup_AdcGroup1_Hw
#define NUM_OF_CHANNEL_ADC2_HW		(1)	//SENS_HV															AdcConf_AdcGroup_AdcGroup3_Hw
#define NUM_OF_CHANNEL_ADC3_HW		(1)	//SENS_CURR_DC (SENS_CURR_DC_REF)20250507										AdcConf_AdcGroup_AdcGroup3_Hw
#define NUM_OF_CHANNEL_ADC0_SW		(2)	//SENS_VDD_15V, SENS_VDD_5V0										AdcConf_AdcGroup_AdcGroup0_Sw
#define NUM_OF_CHANNEL_ADC1_SW		(3)	//SENS_TEMP1, SENS_IPM_TEMP,SENS_PCB_TEMP							AdcConf_AdcGroup_AdcGroup1_Sw
...
#define NUM_OF_CHANNEL_ADC4_SW		(5)	//VUC_5V0, 		VCOM_5V0, 	VREF_5V0, 	VT1_5V0, 	VT2_5V0			AdcConf_AdcGroup_AdcGroup4_Sw

//ADC Buffer Sizes
#define ADC_BUFFER_SIZE_ADC0_HW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC0_HW, ACCESS_MODE_ADC0_HW)
#define ADC_BUFFER_SIZE_ADC1_HW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC1_HW, ACCESS_MODE_ADC1_HW)
#define ADC_BUFFER_SIZE_ADC2_HW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC2_HW, ACCESS_MODE_ADC2_HW)
#define ADC_BUFFER_SIZE_ADC3_HW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC3_HW, ACCESS_MODE_ADC3_HW)
#define ADC_BUFFER_SIZE_ADC0_SW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC0_SW, ACCESS_MODE_ADC0_SW)
#define ADC_BUFFER_SIZE_ADC1_SW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC1_SW, ACCESS_MODE_ADC1_SW)
#define ADC_BUFFER_SIZE_ADC2_SW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC2_SW, ACCESS_MODE_ADC2_SW)
//#define ADC_BUFFER_SIZE_ADC3_SW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC3_SW, ACCESS_MODE_ADC3_SW)
#define ADC_BUFFER_SIZE_ADC4_SW   ADC_BUFFER_SIZE(NUM_OF_CHANNEL_ADC4_SW, ACCESS_MODE_ADC4_SW)
...
#define SMPS_AMP_R1						(1.00)																//KOhm
#define SMPS_AMP_R2						(1.00)																//KOhm
#define SMPS_AMP_R3						(2.30)																//KOhm
#define SMPS_AMP_R4						(2.30)																//KOhm
...
// VUC_VCOM_VVT1_VVT2_VREF_5V0_GAIN_DEFINE
#define VUC_DIV_R1						(0.00)																//kOhm
#define VUC_DIV_R2						(10.0)																//kOhm
#define VUC_DIV_GAIN					(VUC_DIV_R2/(VUC_DIV_R1+VUC_DIV_R2))
#define VUC_VOLTAGE_GAIN				(ADC_SCALE/VUC_DIV_GAIN)
...
// LVDC_GAIN_DEFINE
#define LVDC_DIVIDE_R1					(1000000.0)								//Ohm
#define LVDC_DIVIDE_R2					(230000.0)								//Ohm
...
#define IGDC_DIVIDE_R1					(10000.0)								//Ohm
#define IGDC_DIVIDE_TLF_R1				(10000.0)								//Ohm
#define IGDC_DIVIDE_TLF_R2				(31000.0)								//Ohm
#define IGDC_DIVIDE_ADC_R1				(47000.0)								//Ohm
#define IGDC_DIVIDE_ADC_R2				(18000.0)								//Ohm
...
#define MOTOR_TEMP_FAULT_LOW			(0.2)			//V @ -28.96กษ
#define MOTOR_TEMP_FAULT_HIGH			(4.5)			//V @ 241.70กษ
...
#define CURRENT_OFFSET_BASE				(4095.0/2.0)													//2.5V
#define CURRENT_OFFSET_ERR				(1.5f)															//A,Sensor 0.5A
#define CURRENT_OFFSET_ERR_MIN			(CURRENT_OFFSET_BASE - (CURRENT_OFFSET_ERR / CURRENT_GAIN))
#define CURRENT_OFFSET_ERR_MAX			(CURRENT_OFFSET_BASE + (CURRENT_OFFSET_ERR / CURRENT_GAIN))
...
/*Function declaration for Notification Function of AdcGroup3_Hw*/
extern void AdcGroup3_Hw_Notification(void);
